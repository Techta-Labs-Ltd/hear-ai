...
MIGRATIONS = [
    ("ai_jobs", "backend_id", "VARCHAR"),
    ("ai_jobs", "storage_context_encrypted", "VARCHAR"),
    ...
    ("ai_jobs", "request_hash", "VARCHAR(64)"),
    ("ai_track_jobs", "discovery_json", "JSON"),
    ("regeneration_previews", "backend_id", "VARCHAR"),
    ("regeneration_previews", "storage_context_encrypted", "VARCHAR"),
