...
def save_profile(
    ...
    *,
    ...
    register_temp_standalone(ref_wav, purpose="voice_profile_audio", track_id=user_id)

    ref_txt = os.path.join(pdir, _REFERENCE_TEXT_FILENAME)
    with open(ref_txt, "w") as f:
        f.write(transcript.strip())

    register_temp_standalone(ref_txt, purpose="voice_profile_text", track_id=user_id)
