...
orchestrator = PipelineOrchestrator(transcriber, enhancer, categorizer, moderator)
worker = PipelineWorker(enhancer, transcriber, categorizer, moderator, synthesizer)
