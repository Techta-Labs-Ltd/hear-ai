...
class TTSPostProcessor:
        ...
        try:
            ...
            for sil_s, sil_e in sil_regions:
                ...
                if is_leading or is_trailing:
                    ...
                    keep = min(int(sr * 0.015), sil_e - sil_s)
                    if is_leading:
    ...
    def process(
        ...
        """Run the full TTS post-processing pipeline.

        Order: trim digital silence -> match loudness -> match spectral envelope.
        ...
        logger.info(
            "TTSPostProcessor: tts_dur=%.2fs ref_dur=%.2fs tts_peak=%.4f final_peak=%.4f final_dur=%.2fs",
