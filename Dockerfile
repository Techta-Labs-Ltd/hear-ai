...
RUN uv run --no-sync python -m pytest tests/test_dependency_patches.py tests/test_four_job_contracts.py tests/test_new_fastapi_health.py tests/test_model_asset_manifest.py tests/test_job_executor.py tests/test_serverless_runtime.py tests/test_backend_reporter.py -q
